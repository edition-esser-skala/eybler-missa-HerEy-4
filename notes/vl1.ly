...
KyrieViolinoI = {
  \relative c' {
    ...
    a8.( g16) g4 r
    d~ d16( f) f( a) g( f e d)
    c8([ h]\trill c8) g'16([ e] c e g c)
    c8.(\fz h16 d8) h16([\p f] d f h d) %5
    d8.(\fz c16 e8) e16([\cresc c] g c e g)
    g4~\fz g16( f\p b a g f e d)
    % c8.( d16 h16) g'(\< fis g a\> g e c) % for MIDI
    \after 8 \turn c8.( d16 h16) g'(\< fis g a\> g e c)
    h8(\! d) r16 g,(\< fis g a\> g e c)
    h(\! g' d h) g d''(\mf h g) e'4~ %10
    ...
    g(\cresc a h c cis d e d) f!(\f d h g)
    <f g,>2\fz r4
    ...
    f4. a'8( g16 f e d)
    c8\p h\trill c4 r
    f8~\fzp f32( e d c) h8 r r4 %30
    g'8~\fzp g32( f e d) c8 e,16(\cresc g c e g b)
    b4~\fz b16 a(\p g f e f a, d)
    % c8.( d16 h) g'(\< fis g a\> g e c)  % for MIDI
    \after 8 \turn c8.( d16 h) g'(\< fis g a\> g e c)
    h8(\! d) r16 g,(\< fis g a\> g e c)
    h(\! g' d h) g d''(\mf h g) g'4~ %35
    g16 g,( g' e) c( d e c) f4~
    f16 f,( f' d) h( c d h) e4~
    e16 e,( e' c) a( d f a,) g( e' f, d')
    c( g e c') h8 g16( a) a( h) h( c)
    % c8. e16 g,8 r r4 %40 % for MIDI
    \after 8 \turn c8. e16 g,8 r r4 %40
    r8 d'~ d16( f) f( a) g( f e d)
    f8.( e16 g8) r r4
    r8 c,~\cresc c16 e( f a) g( f e d)
    c(\f h d f) f( d h f) e( e' h c)
    a( d f a) e8 g4-> h,8 %45
    c16(\p d e f fis g a g) e( f d h)
    c( d e f fis g a g) e( f d h)
    c(\cresc d e f fis g a g) b(\f g e c)
    b4 r r
    ...
    c,4.( e8 d16 c h a)
    g4 r r %55
    c16(\perd g c e) c( g c e) c( g c e)
